    ...
    <header>
        <div class="header-top">
            ...
            <ul class="main_icon">
                ...
                if (!empty($_SESSION["userId"])) { ?>
                    ...
                    <li><a href="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/cart"><i class="fa-solid fa-cart-shopping black"></i> <span id="cart-number" class="black"><?= $data["countCarts"] ?></span></a></li>
                ...
                <?php } else { ?>
                    ...
                    <li><a href="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/loginSignup"><i class="fa-solid fa-user black"></i> login</a></li>
                <?php } ?>
            </ul>
            <div class="searching">
        ...
        <div class="header-middle">
            <nav class="sticky">
                ...
                <ul class="main_nav">
                    <li>
                        <a href="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/">Home</a>
                    </li>
                    <li>
                        <a href="#">About us</a>
                    </li>
                    <li>
                        <a href="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/home/productList">Products</a>
                    </li>
                    <li>
                        <a href="#">Blog</a>
                    </li>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div class="order">
                <div class="order-top">
                    ...
                    <a href="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/order">View purchase history ></a>
                </div>
            ...
            <div id="info">
                ...
                <div class="update-info info" id="update-info">
                    <form action="http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/home/updateUser" method="Post">
            ...
            <div id="button">
                ...
                <div class="container">
                    <button type="button" class="read-more" onclick="location.href = 'http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/home/logout'">
                        <h3>Log Out</h3>
                    </button>
                </div>
            </div>
