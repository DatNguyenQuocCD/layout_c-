...
class home extends Controller
{
    ...
    {
        session_destroy();
        header("Location:http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/");
    }
    ...
    function updateUser()
    {
        ...
        if ($usersModel->updateUser($_SESSION["userId"], $name, $phoneNumber, $address, $password)) {
            return header("Location: http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/");
        } else {
            echo "Lỗi";
        }
    }
