        ...
        function addProductToCart($idProduct){
            if($_SESSION != null){
                if(isset($_POST["add-to-cart"])){
                    ...
                    // $cartsModel->addCart($quantity, $idProduct, $_SESSION["userId"]);
                    return header("Location:http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/cart");
                }else{
                    return header("Location:http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn//home/detailProduct/$idProduct");
                }
            }
        }
