    ...
    class Admin extends Controller{
        ...
        // "productList" => $productList->getProductList(),
            if (isset($_POST["cancalAddProduct"])) {
                header("Location:http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/admin");
            }else{
        ...
        function updateStatus($idOrder, $status){
            ...
            return header("Location:http://localhost:8080/T%E1%BB%B1%20h%E1%BB%8Dc%20PHP/otakuvn/admin/showOrders");
        }
